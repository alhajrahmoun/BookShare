...
Rails.application.config.assets.precompile += %w( user-style.css )

Rails.application.config.assets.precompile += %w( register.css )

Rails.application.config.assets.precompile += %w( bookstyle.css )

Rails.application.config.assets.precompile += %w( community-style.css )
